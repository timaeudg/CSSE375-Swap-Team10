...
public class Worker implements Serializable {
	...
	private ArrayList<Date> daysOff;//added to allow for feature SWAP2 team 8
	...
	/*
	 * SWAP 2 TEAM 8 Added this method to remove as much responsibility from
	 * Schedule as possible and hopefully control any feature envy
	 */

	public Boolean isWorkerAvailable(String job, String dayName, ArrayList<String> workersWorking, int curDay, int curMonth) {
		...
		// added for days off feature
		Boolean notOffWork = true;
		
		for(Date d: this.daysOff){
			if(d.getDay() == curDay && d.getMonth() ==curMonth){
				notOffWork = false;
				break;
			}
		}
	...
	void addDaysOff(ArrayList<Date> vocationDays) {
		this.daysOff = vocationDays;
	}
